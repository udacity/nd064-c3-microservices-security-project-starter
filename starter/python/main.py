...
ADMIN_SECRET=Random.new().read(32) #Keep this a secret
APP_NAME = 'Vulnerable Flask App'
APP_VERSION = '0.1'
...
DATABASE_CONTENTS = {
    'public_stuff' : [
        (1, 'NSA Encryption', 'products', 'Dont let your data be compromised, use our patented exabit encryption technology that secures your data so well even you cant read it'),
        ...
        (4, 'Enterprise Endpoint Security', 'solutions', 'Our most cost efficient solution for all your cyber concerns featuring the best value for money, the most effective breaking of the kill chain and the greatest ROI'),
